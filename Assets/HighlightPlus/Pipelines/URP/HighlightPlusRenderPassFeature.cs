        ...
        class HighlightPass : ScriptableRenderPass {
            ...
            public void Setup(RenderPassEvent renderPassEvent, ScriptableRenderer renderer) {
                ...
                if (cbSeeThrough == null) {
                    ...
                    cbSeeThrough.name = "Highlight Plus See-Through";
                }
            }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
                ...
                for (int k = 0; k < count; k++) {
                    ...
                    if (effect.isActiveAndEnabled) {
                        ...
                        CommandBuffer cb = effect.GetCommandBuffer(cam, cameraColorTarget, cameraDepthTarget, cbSeeThrough);
                        if (cb != null) {
                            context.ExecuteCommandBuffer(cb);
                        }
                    }
                }
                context.ExecuteCommandBuffer(cbSeeThrough);
